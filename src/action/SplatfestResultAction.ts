 ...
 */
function respond(app: I18NDialogflowApp, tuple: FestivalResultTuple) {
    const dict = app.getDict()
    const summary = tuple.result.summary
    const nameAlpha = tuple.festival.names.alpha_short
    const nameBravo = tuple.festival.names.bravo_short
    const names = {
